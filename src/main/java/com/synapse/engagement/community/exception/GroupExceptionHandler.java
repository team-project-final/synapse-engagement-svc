...
import com.synapse.engagement.community.controller.GroupController;
import com.synapse.engagement.community.controller.GroupMemberController;
...
@RestControllerAdvice(assignableTypes = {GroupController.class, GroupMemberController.class})
...
class GroupExceptionHandler {
    ...
    ProblemDetail handleGroupMemberNotFound(GroupMemberNotFoundException exception, HttpServletRequest request) {
        return problem(HttpStatus.NOT_FOUND, exception, request);
    }

    @ExceptionHandler({GroupAccessDeniedException.class, GroupMemberPermissionDeniedException.class})
    ...
    @ExceptionHandler({
            ...
            GroupMemberAlreadyExistsException.class,
            GroupMemberRejoinBlockedException.class,
